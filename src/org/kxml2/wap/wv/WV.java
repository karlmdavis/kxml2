...
public abstract class WV {
    ...
    public static final String [] tagTablePage2 = {
        ...
        "MG",           //  0x02, 0x3E /* WV 1.2 */
        "MM",           //  0x02, 0x3F /* WV 1.2 */
        "VRID"         //  0x02, 0x3E /* WV 1.2 : BUG IN SPEC ! The same token than 'MG' */
    };
    ...
    public static final String [] tagTablePage4 = {
        ...
        "CancelAuth-Request",           //  0x04, 0x1E /* WV 1.2 */
    ...
    public static final String [] tagTablePage9 = {
        ...
        "WatcherStatus"             //  0x09, 0x0C /* WV 1.2 : Bug in Spec ! Same token then 'ReactiveAuthStatus' */
    };
