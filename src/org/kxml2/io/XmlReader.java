...
public class XmlReader implements org.xmlpull.v1.XmlPullParser {
    ...
    public XmlReader () {
	this (Runtime.getRuntime ().freeMemory () >= 1048576 ? 8192 : 1);
    }


    public XmlReader (int sz) {
    ...
    private final void adjustNamespaces () throws XmlPullParserException {
	...
	for (int i = attributeCount * 4 - 4; i >= 0; i -= 4) {
		...
		if ((properties & REPORT_NAMESPACE_ATTRIBUTES) !=  REPORT_NAMESPACE_ATTRIBUTES)
	...
	if ((properties & PROCESS_NAMESPACES) == PROCESS_NAMESPACES) 
	    adjustNamespaces ();
    ...
    public final boolean pushEntity (boolean setName) throws IOException, XmlPullParserException{
    ...
    */
    ...
    public boolean getProperty (int property) {
	return (properties & property) == property;
    }

    public void defineCharacterEntity (String entity, 
	...
	for (int i = (getNamespacesCount (getDepth ()) << 1) - 2; i >= 0; i -= 2) {
	    if (prefix == null) {
    ...
    public int getType() throws XmlPullParserException {
	return type;
    }
    ...
    public int nextImpl (boolean token) throws IOException, XmlPullParserException {
